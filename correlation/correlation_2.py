...
legend1=ax1.legend(prop=fontprop2,loc=(0.935,0.88),frameon=True)
legend1.get_frame().set_facecolor('white')
legend1.get_frame().set_alpha(0.7)
legend1.get_frame().set_edgecolor('none')  
legend2=ax2.legend(prop=fontprop2,loc=(0.935,0.94),frameon=True)
legend2.get_frame().set_facecolor('white')
legend2.get_frame().set_alpha(0.7)
legend2.get_frame().set_edgecolor('none')  
legend3=ax3.legend(prop=fontprop2,loc=(0.935,0.82),frameon=False)
legend3.get_frame().set_facecolor('white')
legend3.get_frame().set_alpha(0.7)
legend3.get_frame().set_edgecolor('none')  
ax2.yaxis.label.set_size(12)
ax3.yaxis.label.set_size(12)

correlation, _ = spearmanr(df['Android+IOS 사용자 수'], df2['Android+IOS 사용자 수'])
correlation2, _ = spearmanr(df2['Android+IOS 사용자 수'], df3['Android+IOS 사용자 수'])
correlation3, _ = spearmanr(df['Android+IOS 사용자 수'], df3['Android+IOS 사용자 수'])
